...
if fu=='sec_contact_asym_mig':
	func = demographic_models.sec_contact_asym_mig
	params = ['nu1', 'nu2','m12','m21', 'T1', 'T2']
	upper_bound = [5, 5, 10,10,5,5]
	lower_bound = [1e-2,1e-2,1e-2,1e-2,1e-2,1e-2]#the lower bound should not be zero, because log of zero is NA.
