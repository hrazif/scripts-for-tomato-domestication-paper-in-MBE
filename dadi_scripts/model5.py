...
n_indp = 30 # number of independent estimates of parameter values
...
fs = dadi.Spectrum.from_file('/home/caicedo/Hamid/20190311_redoing_analyses_for_the_paper/7_dadi_dating/1_full_genome_SP_NECU_and_SLCSLL/same_sample_sizes_folded_with_masking/no_gene_flow[converged]/full_genome.fs')
...
'''
if fu=='sec_contact_asym_mig_size':
	func = demographic_models.sec_contact_asym_mig_size
	params = ['nu1a', 'nu2a','nu1b', 'nu2b','m12','m21', 'T1', 'T2']
	upper_bound = [5, 5, 5, 5,10,10,5,5]
	lower_bound = [1e-2,1e-2,1e-2,1e-2,1e-2,1e-2,1e-2,1e-2]#the lower bound should not be zero, because log of zero is NA.
