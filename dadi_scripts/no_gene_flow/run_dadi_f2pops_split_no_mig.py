...
pts_l = [40,50,60] # the grid point settings used for extrapolation. The smallest values should be bigger than the largest value of AFS below.
#=======================================================================
#dd/fs in
...
for i in range(1,n_indp+1):
	#to create random initial parameter values based on upper and lower bounds
	p0=[]
